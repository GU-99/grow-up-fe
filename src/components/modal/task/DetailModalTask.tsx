...
import { useReadAssignees } from '@hooks/query/useTaskQuery';
  ...
  return (
    <ModalPortal>
      <ModalLayout onClose={handleClose}>
        {isStatusLoading || isAssigneeLoading ? (
          <Spinner />
        ) : (
            ...
            <section className="grow space-y-5">
              ...
              <div>
                ...
                <ul className="mb-10 flex flex-wrap gap-5">
                  <li
                    className="flex cursor-pointer items-center gap-5 rounded-md bg-button px-4 py-2"
